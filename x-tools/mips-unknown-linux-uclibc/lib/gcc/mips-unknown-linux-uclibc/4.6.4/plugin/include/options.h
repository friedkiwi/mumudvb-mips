...
enum opt_code
{
  ...
  OPT_fhosted = 586,                         /* -fhosted */
  /* OPT_fhuge_objects = 587, */             /* -fhuge-objects */
  OPT_fident = 588,                          /* -fident */
  OPT_fif_conversion = 589,                  /* -fif-conversion */
  OPT_fif_conversion2 = 590,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 591,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 592,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 593,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 594,             /* -fimplicit-templates */
  OPT_findirect_classes = 595,               /* -findirect-classes */
  OPT_findirect_dispatch = 596,              /* -findirect-dispatch */
  OPT_findirect_inlining = 597,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 598,         /* -finhibit-size-directive */
  OPT_finit_character_ = 599,                /* -finit-character= */
  OPT_finit_integer_ = 600,                  /* -finit-integer= */
  OPT_finit_local_zero = 601,                /* -finit-local-zero */
  OPT_finit_logical_ = 602,                  /* -finit-logical= */
  OPT_finit_real_ = 603,                     /* -finit-real= */
  OPT_finline = 604,                         /* -finline */
  OPT_finline_functions = 605,               /* -finline-functions */
  OPT_finline_functions_called_once = 606,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 607, */            /* -finline-limit- */
  OPT_finline_limit_ = 608,                  /* -finline-limit= */
  OPT_finline_small_functions = 609,         /* -finline-small-functions */
  OPT_finput_charset_ = 610,                 /* -finput-charset= */
  OPT_finstrument_functions = 611,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 612,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 613,/* -finstrument-functions-exclude-function-list= */
  OPT_fintrinsic_modules_path = 614,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 615,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 616,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 617,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 618,                    /* -fipa-profile */
  OPT_fipa_pta = 619,                        /* -fipa-pta */
  OPT_fipa_pure_const = 620,                 /* -fipa-pure-const */
  OPT_fipa_reference = 621,                  /* -fipa-reference */
  OPT_fipa_sra = 622,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 623,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 624,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 625,              /* -fira-loop-pressure */
  OPT_fira_region_ = 626,                    /* -fira-region= */
  OPT_fira_share_save_slots = 627,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 628,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 629,                   /* -fira-verbose= */
  OPT_fivopts = 630,                         /* -fivopts */
  OPT_fjni = 631,                            /* -fjni */
  OPT_fjump_tables = 632,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 633,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 634,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 635,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 636, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 637,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 638,             /* -fleading-underscore */
  OPT_floop_block = 639,                     /* -floop-block */
  OPT_floop_flatten = 640,                   /* -floop-flatten */
  OPT_floop_interchange = 641,               /* -floop-interchange */
  /* OPT_floop_optimize = 642, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 643,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 644,                /* -floop-strip-mine */
  OPT_flto = 645,                            /* -flto */
  OPT_flto_compression_level_ = 646,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 647,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 648,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 649,             /* -flto-partition=none */
  OPT_flto_report = 650,                     /* -flto-report */
  OPT_flto_ = 651,                           /* -flto= */
  OPT_fltrans = 652,                         /* -fltrans */
  OPT_fltrans_output_list_ = 653,            /* -fltrans-output-list= */
  OPT_fmain_ = 654,                          /* -fmain= */
  OPT_fmath_errno = 655,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 656,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 657,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 658,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 659,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 660,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 661,                     /* -fmem-report */
  OPT_fmerge_all_constants = 662,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 663,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 664,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 665,                /* -fmessage-length= */
  OPT_fmodule_private = 666,                 /* -fmodule-private */
  OPT_fmodulo_sched = 667,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 668,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 669,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 670,                  /* -fms-extensions */
  OPT_fmudflap = 671,                        /* -fmudflap */
  OPT_fmudflapir = 672,                      /* -fmudflapir */
  OPT_fmudflapth = 673,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 674, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 675, */                  /* -fnew-abi */
  OPT_fnext_runtime = 676,                   /* -fnext-runtime */
  OPT_fnil_receivers = 677,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 678,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 679,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 680, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 681,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 682,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 683,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 684,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 685,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 686,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 687,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 688,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 689,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 690,             /* -fomit-frame-pointer */
  OPT_fopenmp = 691,                         /* -fopenmp */
  OPT_foperator_names = 692,                 /* -foperator-names */
  OPT_foptimize_register_move = 693,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 694,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 695,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 696, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 697,              /* -foutput-class-dir= */
  OPT_fpack_derived = 698,                   /* -fpack-derived */
  OPT_fpack_struct = 699,                    /* -fpack-struct */
  OPT_fpack_struct_ = 700,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 701,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 702,              /* -fpcc-struct-return */
  OPT_fpch_deps = 703,                       /* -fpch-deps */
  OPT_fpch_preprocess = 704,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 705,                     /* -fpeel-loops */
  OPT_fpeephole = 706,                       /* -fpeephole */
  OPT_fpeephole2 = 707,                      /* -fpeephole2 */
  OPT_fpermissive = 708,                     /* -fpermissive */
  OPT_fpic = 709,                            /* -fpic */
  OPT_fpie = 710,                            /* -fpie */
  OPT_fplan9_extensions = 711,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 712,                    /* -fplugin-arg- */
  OPT_fplugin_ = 713,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 714,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 715,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 716,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 717,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 718,                   /* -fpreprocessed */
  OPT_fpretty_templates = 719,               /* -fpretty-templates */
  OPT_fprofile = 720,                        /* -fprofile */
  OPT_fprofile_arcs = 721,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 722,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 723,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 724,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 725,              /* -fprofile-generate= */
  OPT_fprofile_use = 726,                    /* -fprofile-use */
  OPT_fprofile_use_ = 727,                   /* -fprofile-use= */
  OPT_fprofile_values = 728,                 /* -fprofile-values */
  OPT_fprotect_parens = 729,                 /* -fprotect-parens */
  OPT_frandom_seed = 730,                    /* -frandom-seed */
  OPT_frandom_seed_ = 731,                   /* -frandom-seed= */
  OPT_frange_check = 732,                    /* -frange-check */
  OPT_frealloc_lhs = 733,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 734,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 735,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 736,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 737,                /* -frecord-marker=8 */
  OPT_frecursive = 738,                      /* -frecursive */
  OPT_freduced_reflection = 739,             /* -freduced-reflection */
  OPT_freg_struct_return = 740,              /* -freg-struct-return */
  OPT_fregmove = 741,                        /* -fregmove */
  OPT_frename_registers = 742,               /* -frename-registers */
  OPT_freorder_blocks = 743,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 744,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 745,              /* -freorder-functions */
  OPT_frepack_arrays = 746,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 747,           /* -freplace-objc-classes */
  OPT_frepo = 748,                           /* -frepo */
  OPT_frequire_return_statement = 749,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 750,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 751, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 752,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 753,                    /* -fresolution= */
  OPT_frounding_math = 754,                  /* -frounding-math */
  OPT_frtti = 755,                           /* -frtti */
  OPT_fsaw_java_file = 756,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 757,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 758,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 759,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 760,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 761,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 762,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 763,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 764,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 765,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 766,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 767,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 768,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 769,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 770,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 771,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 772,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 773,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 774, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 775,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 776,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 777,              /* -fsecond-underscore */
  OPT_fsection_anchors = 778,                /* -fsection-anchors */
  /* OPT_fsee = 779, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 780,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 781,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 782, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 783,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 784,          /* -fselective-scheduling2 */
  OPT_fshort_double = 785,                   /* -fshort-double */
  OPT_fshort_enums = 786,                    /* -fshort-enums */
  OPT_fshort_wchar = 787,                    /* -fshort-wchar */
  OPT_fshow_column = 788,                    /* -fshow-column */
  OPT_fsign_zero = 789,                      /* -fsign-zero */
  OPT_fsignaling_nans = 790,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 791,               /* -fsigned-bitfields */
  OPT_fsigned_char = 792,                    /* -fsigned-char */
  OPT_fsigned_zeros = 793,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 794,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 795,               /* -fsource-filename= */
  OPT_fsource_ = 796,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 797,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 798,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 799,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 800, */                 /* -fsquangle */
  /* OPT_fstack_check = 801, */              /* -fstack-check */
  OPT_fstack_check_ = 802,                   /* -fstack-check= */
  OPT_fstack_limit = 803,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 804,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 805,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 806,                /* -fstack-protector */
  OPT_fstack_protector_all = 807,            /* -fstack-protector-all */
  OPT_fstack_usage = 808,                    /* -fstack-usage */
  OPT_fstats = 809,                          /* -fstats */
  OPT_fstore_check = 810,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 811, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 812,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 813,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 814,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 815, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 816,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 817,                    /* -fsyntax-only */
  OPT_ftabstop_ = 818,                       /* -ftabstop= */
  /* OPT_ftarget_help = 819, */              /* -ftarget-help */
  OPT_ftarget_ = 820,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 821, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 822,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 823,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 824, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 825,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 826,             /* -fthreadsafe-statics */
  OPT_ftime_report = 827,                    /* -ftime-report */
  OPT_ftls_model_ = 828,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 829,               /* -ftoplevel-reorder */
  OPT_ftracer = 830,                         /* -ftracer */
  OPT_ftrapping_math = 831,                  /* -ftrapping-math */
  OPT_ftrapv = 832,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 833,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 834,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 835,                       /* -ftree-ccp */
  OPT_ftree_ch = 836,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 837,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 838,                /* -ftree-copyrename */
  OPT_ftree_cselim = 839,                    /* -ftree-cselim */
  OPT_ftree_dce = 840,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 841,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 842,                       /* -ftree-dse */
  OPT_ftree_forwprop = 843,                  /* -ftree-forwprop */
  OPT_ftree_fre = 844,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 845,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 846,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 847,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 848,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 849,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 850,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 851, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 852,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 853,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 854,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 855,                   /* -ftree-phiprop */
  OPT_ftree_pre = 856,                       /* -ftree-pre */
  OPT_ftree_pta = 857,                       /* -ftree-pta */
  OPT_ftree_reassoc = 858,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 859, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 860,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 861,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 862,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 863,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 864, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 865, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 866,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 867,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 868,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 869,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 870,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 871,                       /* -ftree-vrp */
  OPT_funderscoring = 872,                   /* -funderscoring */
  OPT_funit_at_a_time = 873,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 874,               /* -funroll-all-loops */
  OPT_funroll_loops = 875,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 876,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 877,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 878,             /* -funsigned-bitfields */
  OPT_funsigned_char = 879,                  /* -funsigned-char */
  OPT_funswitch_loops = 880,                 /* -funswitch-loops */
  OPT_funwind_tables = 881,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 882,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 883,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 884,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 885,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 886,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 887,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 888,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 889,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 890,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 891,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 892, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 893,                /* -fvect-cost-model */
  OPT_fverbose_asm = 894,                    /* -fverbose-asm */
  /* OPT_fversion = 895, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 896,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 897,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 898,                    /* -fvisibility= */
  OPT_fvpt = 899,                            /* -fvpt */
  /* OPT_fvtable_gc = 900, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 901, */            /* -fvtable-thunks */
  OPT_fweak = 902,                           /* -fweak */
  OPT_fweb = 903,                            /* -fweb */
  OPT_fwhole_file = 904,                     /* -fwhole-file */
  OPT_fwhole_program = 905,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 906,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 907,              /* -fworking-directory */
  OPT_fwpa = 908,                            /* -fwpa */
  OPT_fwrapv = 909,                          /* -fwrapv */
  /* OPT_fxref = 910, */                     /* -fxref */
  OPT_fzee = 911,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 912,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 913,                      /* -fzero-link */
  OPT_g = 914,                               /* -g */
  OPT_gant = 915,                            /* -gant */
  OPT_gcoff = 916,                           /* -gcoff */
  ...
  OPT_gnat = 920,                            /* -gnat */
  OPT_gnatO = 921,                           /* -gnatO */
  OPT_gno_strict_dwarf = 922,                /* -gno-strict-dwarf */
  OPT_gstabs = 923,                          /* -gstabs */
  OPT_gstabs_ = 924,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 925,                   /* -gstrict-dwarf */
  OPT_gtoggle = 926,                         /* -gtoggle */
  OPT_gvms = 927,                            /* -gvms */
  OPT_gxcoff = 928,                          /* -gxcoff */
  OPT_gxcoff_ = 929,                         /* -gxcoff+ */
  OPT_h = 930,                               /* -h */
  OPT_idirafter = 931,                       /* -idirafter */
  OPT_imacros = 932,                         /* -imacros */
  OPT_imultiarch = 933,                      /* -imultiarch */
  OPT_imultilib = 934,                       /* -imultilib */
  OPT_include = 935,                         /* -include */
  OPT_iplugindir_ = 936,                     /* -iplugindir= */
  OPT_iprefix = 937,                         /* -iprefix */
  OPT_iquote = 938,                          /* -iquote */
  OPT_isysroot = 939,                        /* -isysroot */
  OPT_isystem = 940,                         /* -isystem */
  OPT_iwithprefix = 941,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 942,               /* -iwithprefixbefore */
  OPT_k8 = 943,                              /* -k8 */
  OPT_l = 944,                               /* -l */
  OPT_lang_asm = 945,                        /* -lang-asm */
  OPT_mabi_ = 946,                           /* -mabi= */
  OPT_mabicalls = 947,                       /* -mabicalls */
  OPT_mad = 948,                             /* -mad */
  OPT_mandroid = 949,                        /* -mandroid */
  OPT_march_ = 950,                          /* -march= */
  OPT_mbionic = 951,                         /* -mbionic */
  OPT_mbranch_cost_ = 952,                   /* -mbranch-cost= */
  OPT_mbranch_likely = 953,                  /* -mbranch-likely */
  OPT_mcheck_zero_division = 954,            /* -mcheck-zero-division */
  OPT_mcode_readable_ = 955,                 /* -mcode-readable= */
  OPT_mdebug = 956,                          /* -mdebug */
  OPT_mdebugd = 957,                         /* -mdebugd */
  OPT_mdivide_breaks = 958,                  /* -mdivide-breaks */
  OPT_mdivide_traps = 959,                   /* -mdivide-traps */
  OPT_mdmx = 960,                            /* -mdmx */
  OPT_mdouble_float = 961,                   /* -mdouble-float */
  OPT_mdsp = 962,                            /* -mdsp */
  OPT_mdspr2 = 963,                          /* -mdspr2 */
  OPT_meb = 964,                             /* -meb */
  OPT_mel = 965,                             /* -mel */
  OPT_membedded_data = 966,                  /* -membedded-data */
  OPT_mexplicit_relocs = 967,                /* -mexplicit-relocs */
  OPT_mextern_sdata = 968,                   /* -mextern-sdata */
  OPT_mfix_r10000 = 969,                     /* -mfix-r10000 */
  OPT_mfix_r4000 = 970,                      /* -mfix-r4000 */
  OPT_mfix_r4400 = 971,                      /* -mfix-r4400 */
  OPT_mfix_sb1 = 972,                        /* -mfix-sb1 */
  OPT_mfix_vr4120 = 973,                     /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 974,                     /* -mfix-vr4130 */
  OPT_mfix4300 = 975,                        /* -mfix4300 */
  OPT_mflip_mips16 = 976,                    /* -mflip-mips16 */
  OPT_mflush_func_ = 977,                    /* -mflush-func= */
  OPT_mfp_exceptions = 978,                  /* -mfp-exceptions */
  OPT_mfp32 = 979,                           /* -mfp32 */
  OPT_mfp64 = 980,                           /* -mfp64 */
  OPT_mfused_madd = 981,                     /* -mfused-madd */
  OPT_mglibc = 982,                          /* -mglibc */
  OPT_mgp32 = 983,                           /* -mgp32 */
  OPT_mgp64 = 984,                           /* -mgp64 */
  OPT_mgpopt = 985,                          /* -mgpopt */
  OPT_mhard_float = 986,                     /* -mhard-float */
  OPT_minterlink_mips16 = 987,               /* -minterlink-mips16 */
  OPT_mips = 988,                            /* -mips */
  OPT_mips16 = 989,                          /* -mips16 */
  OPT_mips3d = 990,                          /* -mips3d */
  OPT_mllsc = 991,                           /* -mllsc */
  OPT_mlocal_sdata = 992,                    /* -mlocal-sdata */
  OPT_mlong_calls = 993,                     /* -mlong-calls */
  OPT_mlong32 = 994,                         /* -mlong32 */
  OPT_mlong64 = 995,                         /* -mlong64 */
  OPT_mmcount_ra_address = 996,              /* -mmcount-ra-address */
  OPT_mmemcpy = 997,                         /* -mmemcpy */
  OPT_mmips_tfile = 998,                     /* -mmips-tfile */
  OPT_mmt = 999,                             /* -mmt */
  OPT_mno_float = 1000,                      /* -mno-float */
  OPT_mno_flush_func = 1001,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1002,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1003,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1004,                     /* -mno-mips3d */
  OPT_mpaired_single = 1005,                 /* -mpaired-single */
  OPT_mplt = 1006,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1007,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1008,               /* -mrelax-pic-calls */
  OPT_mshared = 1009,                        /* -mshared */
  OPT_msingle_float = 1010,                  /* -msingle-float */
  OPT_msmartmips = 1011,                     /* -msmartmips */
  OPT_msoft_float = 1012,                    /* -msoft-float */
  OPT_msplit_addresses = 1013,               /* -msplit-addresses */
  OPT_msym32 = 1014,                         /* -msym32 */
  OPT_msynci = 1015,                         /* -msynci */
  OPT_mtune_ = 1016,                         /* -mtune= */
  OPT_muclibc = 1017,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1018,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1019,                  /* -mvr4130-align */
  OPT_mxgot = 1020,                          /* -mxgot */
  OPT_n = 1021,                              /* -n */
  OPT_no_canonical_prefixes = 1022,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1023,              /* -no-integrated-cpp */
  OPT_noasmopt = 1024,                       /* -noasmopt */
  OPT_nocpp = 1025,                          /* -nocpp */
  OPT_nodefaultlibs = 1026,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1027,                   /* -nostartfiles */
  OPT_nostdinc = 1028,                       /* -nostdinc */
  OPT_nostdinc__ = 1029,                     /* -nostdinc++ */
  OPT_nostdlib = 1030,                       /* -nostdlib */
  OPT_o = 1031,                              /* -o */
  OPT_p = 1032,                              /* -p */
  OPT_pass_exit_codes = 1033,                /* -pass-exit-codes */
  OPT_pedantic = 1034,                       /* -pedantic */
  OPT_pedantic_errors = 1035,                /* -pedantic-errors */
  OPT_pg = 1036,                             /* -pg */
  OPT_pie = 1037,                            /* -pie */
  OPT_pipe = 1038,                           /* -pipe */
  OPT_posix = 1039,                          /* -posix */
  OPT_print_file_name_ = 1040,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1041,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1042,          /* -print-multi-directory */
  OPT_print_multi_lib = 1043,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1044,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1045,                /* -print-multiarch */
